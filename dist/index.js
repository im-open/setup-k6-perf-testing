      ...
      if (plat === 'darwin') {
        ...
        if (lsbContents) {
          ...
          for (const line of lines) {
            ...
            if (
              parts.length === 2 &&
              (parts[0].trim() === 'VERSION_ID' || parts[0].trim() === 'DISTRIB_RELEASE')
            ) {
...
var require_retry_helper = __commonJS({
  'node_modules/@actions/tool-cache/lib/retry-helper.js'(exports2) {
    ...
    var RetryHelper = class {
      ...
      getSleepAmount() {
        return (
          Math.floor(Math.random() * (this.maxSeconds - this.minSeconds + 1)) + this.minSeconds
        );
      }
      sleep(seconds) {
        return __awaiter(this, void 0, void 0, function* () {
...
var require_tool_cache = __commonJS({
  'node_modules/@actions/tool-cache/lib/tool-cache.js'(exports2) {
    ...
    Object.defineProperty(exports2, '__esModule', { value: true });
    exports2.evaluateVersions =
      exports2.isExplicitVersion =
      exports2.findFromManifest =
      exports2.getManifestFromRepo =
      exports2.findAllVersions =
      exports2.find =
      exports2.cacheFile =
      exports2.cacheDir =
      exports2.extractZip =
...
async function installK6Zip(versionSpec, osArch = 'amd64', extensionZipPath) {
  ...
  if (extensionZipPath) {
    ...
    let extPath;
    if (osPlat == 'win32') {
      extPath = await tc.extractTar(extensionZipPath, void 0, ['xzfm']);
    } else {
      core.info('Extracting on Linux');
      extPath = await tc.extractTar(extensionZipPath, void 0, ['xzvfm']);
    }
    core.info('Adding to the cache ...');
